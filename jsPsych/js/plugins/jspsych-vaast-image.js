 ...
 **/
 ...
 jsPsych.plugins['iat-image'] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    var leftKeyCode = jsPsych.pluginAPI.convertKeyCharacterToKeyCode(trial.approach_key);
    ...
    if (trial.approach_key != jsPsych.NO_KEYS && trial.right_category_key != jsPsych.NO_KEYS) {
      var keyboardListener = jsPsych.pluginAPI.getKeyboardResponse({
        callback_function: after_response,
        valid_responses: [trial.approach_key, trial.right_category_key],
        rt_method: 'date',
        persist: false,
